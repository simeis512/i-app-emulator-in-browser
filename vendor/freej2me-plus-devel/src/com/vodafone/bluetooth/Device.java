...
public class Device 
{
	...
	public final String getFriendlyName() { return null; }

	public final synchronized void startServiceSeek(BaseService[] paramArrayOfBaseService, SeekListener paramSeekListener) { }

	public final synchronized boolean stopServiceSeek() { return false; }

	public final String getBluetoothAddress() { return null; }
}