...
public abstract interface MailData extends DataElement 
{
	...
	public abstract boolean isUnRead() throws IOException;

	public abstract boolean hasRemainder() throws IOException;

	public abstract int hasSendState() throws IOException;

	public abstract int getAttachedFileCount() throws IOException;

	public abstract String getAttachedFileName(int paramInt) throws IOException;

	public abstract byte[] getAttachedFileData(int paramInt) throws IOException;

	public abstract void setState(int paramInt) throws IOException;

	public abstract int setAttachedFile(String paramString) throws IOException;

	public abstract int setAttachedData(byte[] paramArrayOfByte, String paramString, int paramInt) throws IOException;

	public abstract void removeAttachedFile(int paramInt) throws IOException;

	public abstract void setConfirm(int paramInt) throws IOException;

	public abstract void setPriority(int paramInt) throws IOException;
}