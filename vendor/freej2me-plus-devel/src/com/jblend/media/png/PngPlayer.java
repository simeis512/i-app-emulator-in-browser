...
public class PngPlayer extends MediaPlayer implements MediaImageOperator 
{
	public PngPlayer() { }

	public PngPlayer(PngData paramPngData) { this(); }

	public PngPlayer(byte[] paramArrayOfByte) { this(); }
