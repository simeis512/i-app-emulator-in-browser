...
public interface BitstreamErrors
{
	 ...
	 */
	static public final int UNKNOWN_ERROR = 0x100 + 0;
	
	/**
	 * The header describes an unknown sample rate.
	 */
	static public final int UNKNOWN_SAMPLE_RATE = 0x100 + 1;

	/**
	 * A problem occurred reading from the stream.
	 */
	static public final int STREAM_ERROR = 0x100 + 2;
	
	/**
	 * The end of the stream was reached prematurely. 
	 */
	static public final int UNEXPECTED_EOF = 0x100 + 3;
	
	/**
	 * The end of the stream was reached. 
	 */
	static public final int STREAM_EOF = 0x100 + 4;
	
	/**
	 * Frame data are missing. 
	 */
	static public final int INVALIDFRAME = 0x100 + 5;
