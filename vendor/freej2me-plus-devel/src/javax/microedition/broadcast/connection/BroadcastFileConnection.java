...
public interface BroadcastFileConnection extends BroadcastConnection, javax.microedition.io.InputConnection 
{
    ...
    java.util.Enumeration list(String filter) throws java.io.IOException;
